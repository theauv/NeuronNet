 ...
 */
///@{
    void uniform_double(std::vector<double>& vec, double lower=0, double upper=1);
    double uniform_double(double lower=0, double upper=1);
    void normal(std::vector<double>& vec, double mean=0, double sd=1);
    double normal(double mean=0, double sd=1);
    void poisson(std::vector<int>& vec, double mean=1);
